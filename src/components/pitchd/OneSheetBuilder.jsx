...
export default function OneSheetBuilder({ data, onReset, writerName, writerPhone, writerEmail, attachedTalent: initAttached, onExportDone, wasTruncated = false }) {
  ...
  const handleExport = async () => {
    ...
    const sheet = [
      ...
      '</div>',
      '<div style="background:#1a1a1a;padding:20px 22px 58px;display:flex;flex-direction:column;justify-content:center;align-items:center;min-height:110px;">',
      '<div style="font-family:\'DM Mono\',monospace;font-size:7px;text-transform:uppercase;letter-spacing:2px;color:#0d9488;margin-bottom:5px;text-align:center;">A Film Titled</div>',
      `<div style="font-family:'Bebas Neue',sans-serif;font-size:38px;color:#ffffff;line-height:0.95;letter-spacing:1px;text-align:center;">${primaryTitle.toUpperCase()}</div>`,
      '</div>',
