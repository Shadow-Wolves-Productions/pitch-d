...
export default function Logo({ size = 80 }) {
  ...
  return (
    <div className="flex flex-col items-start" style={{ marginLeft: `-${Math.round(size * 0.55)}px`, marginTop: `-${Math.round(size * 1.1)}px`, marginBottom: `-${Math.round(size * 0.85)}px` }}>
      <img
        src={LOGO_URL}
        alt="PITCH'D"
